...
ActiveRecord::Schema.define(version: 20180911070851) do
  ...
  create_table "accounts", force: true do |t|
    ...
    t.string   "address"
    t.string   "platform",                                                  default: "ethereum"
  end
  ...
  create_table "channels", force: true do |t|
    t.integer  "deposit_sort_order", limit: 3
    t.integer  "deposit_min",                    default: 15
    t.integer  "deposit_max",                    default: 30
    t.integer  "fixed",              limit: 2,   default: 2
    t.integer  "fee_max",                        default: 0
    t.integer  "min",                            default: 0
    t.integer  "max",                            default: 100000
    t.integer  "fee",                            default: 0
    t.boolean  "proportion",                     default: true
  ...
  create_table "currencies", force: true do |t|
    ...
    t.boolean  "coin",                           default: true
    t.boolean  "visible",                        default: true
    t.integer  "quick_withdraw_max",             default: 0
    t.datetime "created_at"
    t.datetime "updated_at"
    t.text     "extra"
    t.string   "platform",                       default: "ethereum"
  ...
  create_table "etransactions", force: true do |t|
    ...
    t.string   "meth",         default: "transferFrom"
    t.integer  "parent_id",    default: 0
    t.integer  "tran_type",    default: 0
    t.string   "order_no"
  ...
  create_table "markets", force: true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "price_precision", default: 6
  end
  ...
  create_table "members", force: true do |t|
    ...
    t.datetime "verified_phone_at"
    t.integer  "day"
  end

  add_index "members", ["email"], name: "index_members_on_email", using: :btree
  add_index "members", ["identity_id"], name: "index_members_on_identity_id", using: :btree
  add_index "members", ["phone_number"], name: "index_members_on_phone_number", using: :btree
  ...
  add_index "tickers", ["market_id"], name: "index_tickers_on_market_id", using: :btree
  add_index "tickers", ["timestamp"], name: "index_tickers_on_timestamp", using: :btree
  ...
  create_table "trade_bots", force: true do |t|
    t.string   "exchange"
    t.string   "api_key"
    t.string   "secret"
    t.string   "endpoint"
  ...
  create_table "trades", force: true do |t|
    ...
    t.integer  "timestamp"
    t.decimal  "bid_fee",       precision: 32, scale: 16
    t.decimal  "ask_fee",       precision: 32, scale: 16
    t.decimal  "bid_fee_rate",  precision: 6,  scale: 6
    t.decimal  "ask_fee_rate",  precision: 6,  scale: 6
  end
  ...
  add_index "trades", ["timestamp"], name: "index_trades_on_timestamp", using: :btree
  ...
  add_index "user_logs", ["day"], name: "index_user_logs_on_day", using: :btree
  add_index "user_logs", ["member_id"], name: "index_user_logs_on_member_id", using: :btree
